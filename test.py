...
train_csv = pd.read_csv(os.path.join(args.data, 'train_dataset.csv'))
test_csv = pd.read_csv(os.path.join(args.data, 'test_dataset.csv'))
val_csv = pd.read_csv(os.path.join(args.data, 'val_dataset.csv'))
...
model = TRANSFORMER(num_classes=args.num_classes, n_stacks=args.num_layers, n_units=args.hidden_size, n_heads=args.n_heads , d_ff=args.d_ff, dropout=1.-args.dp_keep_prob, image_size=args.rescale,
